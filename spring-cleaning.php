...
<head>
    ...
    <title>Spring Cleaning | Bond Cleaning Services</title>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/spring-cleaning.css">
...
<body>
    ...
    <div class="main">
        <div class="main-child">
            <div class="left"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/spr.png" alt=""></div>
            <div class="right">
    ...
    <div class="about-us">
        <div class="about-parent">
            <h1>Spring Cleaning | Bond Cleaning Service</h1>
            <p>Revitalize your home with our comprehensive spring cleaning services at Bond Cleaning Service. Our expert team performs a meticulous, top-to-bottom clean to banish months of dust and grime, leaving your home feeling truly refreshed and renewed. From deep-cleaning carpets to washing windows and scrubbing surfaces, we ensure every corner of your space is spotless and revitalized, preparing your home for the new season.</p>
            <div class="about-child">
                <h1>Why Choose Spring Cleaning Services?</h1>
                <div class="sub-child">
                    <div class="sub-child-left">
                        <h2>Experienced Professionals</h2>
                        <p>Our team consists of skilled and trained cleaning experts who bring years of experience and a keen eye for detail to every job. We ensure high standards of cleanliness and professionalism.</p>
                        <h2>Eco-Friendly Products</h2>
                        <p>We are committed to using environmentally-friendly cleaning products that are safe for your family and pets while still being effective at removing dirt and allergens.</p>
                        <h2>Tailored Services</h2>
                        <p>We offer customizable cleaning solutions designed to meet your specific needs and preferences. Whether you need a full-house clean or focus on particular areas, we accommodate your requirements.</p>
                        <h2>Reliable and Trustworthy</h2>
                        <p>Our clients rely on us for consistent, punctual service and exceptional customer care. We prioritize trust and reliability, ensuring your home is in good hands.</p>
                    </div>
                    <div class="sub-child-right">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/spr(1).png" alt="">
                    </div>
                </div>
            </div>
        </div>    
    ...
    <div class="about-us2">
        <div class="about-parent2">
            <div class="about-child2">
                    <h1>4 Key Benefits of Our Spring Cleaning Services</h1>
                    <div class="sub-child-2">
                        <div class="sub-child-2-left">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/spr(2).png" alt="">
                        </div>
                        <div class="sub-child-2-right">
                            <h2>Thorough Deep Cleaning</h2>
                            <p>Our spring cleaning services include a meticulous clean of every part of your home, reaching those often-overlooked areas and ensuring a comprehensive refresh.</p>
                            <h2>Enhanced Indoor Air Quality</h2>
                            <p>By removing accumulated dust, allergens, and other pollutants, our cleaning services help improve the air quality in your home, creating a healthier environment for you and your family.</p>
                            <h2>Revitalized Home Appearance</h2>
                            <p>Experience a noticeable difference in your home’s appearance with our detailed cleaning. We restore the freshness and brightness of your living spaces, making your home feel like new.</p>
                            <h2>Convenience and Time Savings</h2>
                            <p>Save yourself the time and effort of a deep clean by letting our professionals handle the job. We manage all aspects of the cleaning process, allowing you to focus on other important tasks or simply relax.</p>
                        </div>
                    </div>
            </div>
            <span>Customer Satisfaction Guarantee</span>
            <p>At Bond cleaning services, customer satisfaction is our top priority. We are committed to providing high-quality spring cleaning services that exceed your expectations. If you’re not completely satisfied with our service, we’ll work with you to make it right.</p>
            <span>Contact Us</span>
            <p>Ready to make your carpets look new again and secure your bond refund? Contact us today to schedule your spring cleaning services. Our friendly team is here to answer any questions and provide you with a free quote.</p>
        </div>
    </div>
    <!-- about section end -->
        ...
        <div class="follow-container-inner">
            <div class="inner-child">
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/spr(3).png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/spr(4).png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/spr(5).png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/spr(6).png" alt="pic" />
                </div>
            </div>
            <div class="inner-child">
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/spr(7).png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/spr(8).png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/spr(9).png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/spr(10).png" alt="pic" />
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="why-child">
                <div class="whysub-child-2">
                    ...
                    <div class="whysub-child-2-right">
                        ...
                        <p>Selecting Bond Cleaning for your home cleaning needs ensures a premium level of service and
                            peace of mind. With our proven track record of excellence, we offer unmatched
                            professionalism, reliability, and attention to detail. Our dedicated team utilizes
                            industry-leading techniques and top-quality products to deliver exceptional results, leaving
                            your home spotless and refreshed. Trust in our expertise to exceed your expectations and
                            provide you with a hassle-free cleaning experience, allowing you to enjoy a pristine living
                            space without the stress.</p>
    ...
    <div class="bcs-bond-faqs">
        <div class="bcs-bond-faqs-child">
            <h2>FAQs on Spring Cleaning Service</h2>
