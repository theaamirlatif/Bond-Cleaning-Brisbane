...
<head>
    ...
    <title>Bond Cleaning | Bond Cleaning Services</title>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/bond-cleaning.css">
...
<body>
    ...
    <div class="main">
        <div class="main-child">
            <div class="left"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/bc.png" alt=""></div>
            <div class="right">
    ...
    <div class="about-us">
        <div class="about-parent">
            <h1>Expert Bond Cleaning for a Stress-Free Move</h1>
            <p>Our professional bond cleaning services ensure your rental property is spotless and meets the required standards for a full bond refund. We handle every aspect of deep cleaning, from carpets to windows, using advanced tools and techniques. Let us take the stress out of your move by providing a thorough, hassle-free cleaning solution.</p>
            <div class="about-child">
                <h1>Why Choose Bond Cleaning Services?</h1>
                <div class="sub-child">
                    <div class="sub-child-left">
                        <h2>Guarantees Full Bond Return</h2>
                        <p>Professional bond cleaners ensure your property meets the required standards, maximizing your chances of getting your full bond back.</p>
                        <h2>Saves Time and Energy</h2>
                        <p>Expert cleaners handle the time-consuming task of deep cleaning, giving you more time to focus on your move.</p>
                        <h2>Expert Cleaning with Proper Tools</h2>
                        <p>Bond cleaning services use advanced equipment and cleaning products to deliver a thorough, high-quality clean.</p>
                        <h2>Stress-Free Moving</h2>
                        <p>Letting professionals handle the cleaning reduces stress, making your moving process smoother and more manageable.</p>
                        <h2>Final Inspection</h2>
                        <p>Our team conducts a thorough check to guarantee your carpets meet our high standards before considering the job complete.</p>
                    </div>
                    <div class="sub-child-right">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/bc(1).png" alt="">
                    </div>
                </div>
            </div>
        </div>    
    ...
    <div class="about-us2">
        <div class="about-parent2">
            <div class="about-child2">
                    <h1>4 Key Benefits of Professional Bond Cleaning Services</h1>
                    <div class="sub-child-2">
                        <div class="sub-child-2-left">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/bc(2).png" alt="">
                        </div>
                        <div class="sub-child-2-right">
                            <h2>Ensures Full Bond Refund</h2>
                            <p>Professionals meet strict cleaning standards, improving your chances of getting the full bond back without disputes.</p>
                            <h2>Saves Time and Effort</h2>
                            <p>Hiring experts frees you from the time-consuming task of deep cleaning, allowing you to focus on other moving priorities.</p>
                            <h2>Advanced Tools and Expertise</h2>
                            <p>Bond cleaners use specialized equipment and techniques to ensure a deep, thorough clean that meets landlord requirements.</p>
                            <h2>Reduces Stress</h2>
                            <p>Outsourcing the cleaning process alleviates the pressure and stress of moving, making the transition smoother and easier.</p>
                        </div>
                    </div>
            </div>
        ...
        <div class="follow-container-inner">
            <div class="inner-child">
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/bc(3).png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/bc(4).png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/bc(5).png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/bc(6).png" alt="pic" />
                </div>
            </div>
            <div class="inner-child">
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/bc(7).png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/bc(8).png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/bc(9).png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/bc(10).png" alt="pic" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bcs-bond-faqs">
        <div class="bcs-bond-faqs-child">
            <h2>FAQs on Bond Cleaning Service</h2>
