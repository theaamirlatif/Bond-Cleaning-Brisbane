    ...
    <div class="main">
        <div class="main-child">
            <div class="left">
                ...
                <h3><a href="#"><i class="fa fa-envelope"></i>hello@gmail.com</a></h3>
                <h3><a href="#"><i class="fa fa-phone"></i>+62 132 432 342</a></h3>
            </div>
            <div class="right">
                <h2>Contact us</h2>
    ...
    <div class="trusted-service">
        <div class="trusted-service-child">
            <div class="trusted-service-left">
                <h2>Get in Touch with Brisbane’s Premier Bond Cleaners</h2>
                <p>Looking for the best bond cleaners in Brisbane? You've come to the right place! Our platform connects you with highly-rated bond cleaning experts in your area, offering a seamless booking experience and exceptional cleaning services designed to fit your budget. Whether you're moving out or need a comprehensive end-of-lease clean, our trusted professionals ensure your rental property is left spotless.
                </p>
            </div>
