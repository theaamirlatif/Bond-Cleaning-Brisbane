...
<head>
    ...
    <title>Pest Control | Bond Cleaning Services</title>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/pest.css">
...
<body>
    ...
    <div class="main">
        <div class="main-child">
            <div class="left"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/pest1.png" alt=""></div>
            <div class="right">
                <h3>Book Our Services</h3>
                <p>Request a tailored quote from us today and take the first step towards a cleaner, healthier space.
                </p>
                <form action="">
                    ...
                    <div class="row myform-group">
                        <input type="phone" placeholder="Phone">
                        <input type="date" placeholder="Date">
                    </div>
                    <div class="row myform">
                        <button type="submit">Book Now <i class="fa fa-arrow-right"></i></button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="about-us">
        <div class="about-parent">
            <h1>Expert Pest Control for a Safe and Comfortable Home in Brisbane</h1>
            <p>Our professional pest control services in Brisbane ensure your property remains free from pests, delivering a clean and safe living environment. We handle issues such as rodents, cockroaches, and termites using advanced techniques and integrated pest management. Let us simplify pest control for you with a comprehensive, effective solution tailored to your needs.</p>
            <div class="about-child">
                <h1>Why Choose Our Brisbane Pest Control Services?</h1>
                <div class="sub-child">
                    <div class="sub-child-left">
                        <h2>Ensures a Pest-Free Home</h2>
                        <p>Our expert pest control professionals guarantee a thorough treatment of your property, minimizing health risks and preventing damage from pests.</p>
                        <h2>Saves Time and Effort</h2>
                        <p>Our skilled technicians manage the detailed and time-consuming task of pest elimination, allowing you to focus on other important aspects of your life.</p>
                        <h2>Advanced Pest Control Techniques</h2>
                        <p>We use cutting-edge equipment and targeted treatments to deliver a high-quality, effective pest management solution tailored for Brisbane's unique pest challenges.</p>
                        <h2>Stress-Free Experience</h2>
                        <p>Letting professionals handle your pest control needs reduces stress, ensuring a safer and more comfortable living environment.</p>
                        <h2>Comprehensive Inspection</h2>
                        <p>Our team conducts a meticulous inspection of your Brisbane property to identify pest activity and entry points, ensuring a precise and effective treatment plan before completing the job.</p>
                    </div>
                    <div class="sub-child-right">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pest2.png" alt="">
                    </div>
                </div>
            </div>
        </div>    
    ...
    <div class="quote-us">
                <div class="quote-parent">
                    <div class="quote-child-left">
                        <h1>Get Your Personalized Cleaning Quote Now!</h1>
                        <p>Let Us Tailor Your Cleaning Solution Today!</p>
                    </div>
                    <div class="quote-child-right">
                        <form action="">
                            <div class="row myform1">
                                <input type="text" placeholder="Your Name">
                            </div>
                            <div class="row myform-group1">
                                <input type="phone" placeholder="Phone">
                                <input type="date" placeholder="Date">
                            </div>
                            <div class="row myform1">
    ...
    <!-- qoute section end -->
    <div class="about-us2">
        <div class="about-parent2">
            <div class="about-child2">
                    <h1>4 Key Benefits of Professional Bond Cleaning Services in Brisbane</h1>
                    <div class="sub-child-2">
                        <div class="sub-child-2-left">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pest3.png" alt="">
                        </div>
                        <div class="sub-child-2-right">
                            <h2>Ensures Full Bond Refund</h2>
                            <p>Our professional bond cleaning services in Brisbane adhere to strict cleaning standards, significantly improving your chances of receiving your full bond back without disputes.</p>
                            <h2>Saves Time and Effort</h2>
                            <p>By hiring our expert cleaners, you can avoid the time-consuming task of deep cleaning your property, allowing you to focus on other important moving priorities.</p>
                            <h2>Advanced Tools and Expertise</h2>
                            <p>Our bond cleaning specialists use specialized equipment and techniques to deliver a deep, thorough clean that meets Brisbane landlords' requirements and expectations.</p>
                            <h2>Reduces Stress</h2>
                            <p>Outsourcing the cleaning process to our professionals alleviates the pressure and stress of moving, making your transition smoother and more manageable.</p>
                        </div>
                    </div>
            </div>
            <span>Customer Satisfaction Guarantee</span>
            <p>At our Brisbane bond cleaning services, customer satisfaction is our top priority. We are committed to providing high-quality cleaning services that exceed your expectations. If you’re not completely satisfied, we will work with you to resolve any issues.</p>
            <span>Contact Us</span>
            <p>Ready to make your property spotless and secure your bond refund? Contact us today to schedule your bond cleaning services in Brisbane. Our friendly team is here to answer any questions and provide you with a free quote.</p>
        </div>
    </div>
    <!-- about section end -->
    <!-- follow section start -->
    <div class="follow-container">
        <div class="follow-container-inner">
            <div class="inner-child">
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pet1.png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pet2.png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pet3.png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pet4.png" alt="pic" />
                </div>
            </div>
            <div class="inner-child">
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pet5.png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pet6.png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pet7.png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pet8.png" alt="pic" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="why-us">
        <div class="why-parent">
            <div class="why-child">
                <div class="whysub-child-2">
                    <div class="whysub-child-2-left">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pest4.png" alt="">
                    </div>
                    <div class="whysub-child-2-right">
                        <h2>Why Choose Us for Professional Bond Cleaning Services in Brisbane?</h2>
                        <p>When it comes to selecting a bond cleaning service for your home in Brisbane, our platform is the top choice. We connect you with trusted and verified bond cleaning experts who have undergone rigorous screening. Our recommended professionals are experienced, reliable, and skilled in delivering exceptional cleaning results. Our network provides a wide range of bond cleaning services tailored to meet your specific needs. Whether you require a deep clean for carpets, windows, or other areas, our experts have the tools and expertise to handle it all.</p>
