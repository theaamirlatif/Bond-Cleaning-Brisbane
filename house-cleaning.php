...
<head>
    ...
    <title>House Cleaning | Bond Cleaning Services</title>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/house-cleaning.css">
...
<body>
    ...
    <div class="main">
        <div class="main-child">
            <div class="left"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/hc.png" alt=""></div>
            <div class="right">
    ...
    <div class="about-us">
        <div class="about-parent">
            <h1>House Cleaning Services | Bond Cleaning Service</h1>
            <p>Transform your home into a pristine haven with our top-notch house cleaning services at Bond Cleaning Service. We offer a comprehensive cleaning solution tailored to meet your needs, whether you require a routine tidy-up or a more intensive clean. Our team of professional cleaners is dedicated to delivering exceptional results, ensuring every room in your home is spotless and welcoming.</p>
            <div class="about-child">
                <h1>Why Choose House Cleaning Services?</h1>
                <div class="sub-child">
                    <div class="sub-child-left">
                        <h2>Experienced and Reliable Cleaners</h2>
                        <p>Our team consists of highly trained professionals who bring experience and a strong work ethic to every job. You can trust us to deliver consistent, high-quality cleaning every time.</p>
                        <h2>Customized Cleaning Plans</h2>
                        <p>We offer flexible cleaning schedules and tailored services to fit your specific needs and preferences. Whether you need a standard clean or specialized services, we’ve got you covered.</p>
                        <h2>Eco-Friendly Cleaning Solutions</h2>
                        <p>We use environmentally-friendly cleaning products that are effective yet gentle on the environment, ensuring a safe and healthy home for you and your loved ones.</p>
                        <h2>Attention to Detail</h2>
                        <p>Our meticulous cleaning approach ensures that no detail is overlooked. From scrubbing baseboards to wiping light switches, we handle all the little things that make a big difference.</p>
                    </div>
                    <div class="sub-child-right">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hc(1).png" alt="">
                    </div>
                </div>
            </div>
        </div>    
    ...
    <div class="about-us2">
        <div class="about-parent2">
            <div class="about-child2">
                    <h1>Key Benefits of Our House Cleaning Services</h1>
                    <div class="sub-child-2">
                        <div class="sub-child-2-left">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hc(2).png" alt="">
                        </div>
                        <div class="sub-child-2-right">
                            <h2>Consistent Cleanliness</h2>
                            <p>Enjoy the peace of mind that comes with a consistently clean home. Our regular cleaning services ensure that your living space remains tidy and fresh.</p>
                            <h2>Healthier Living Environment</h2>
                            <p>Our thorough cleaning practices help remove dust, allergens, and bacteria, contributing to a healthier indoor environment and reducing the risk of allergies and respiratory issues.</p>
                            <h2>Time and Convenience</h2>
                            <p>Let us handle the cleaning chores so you can spend your time on more enjoyable activities. Our efficient service saves you time and effort, making home maintenance effortless.</p>
                            <h2>Professional Quality</h2>
                            <p>Benefit from the expertise and high standards of our professional cleaners. We deliver a superior clean that goes beyond standard cleaning methods, leaving your home looking and feeling its best.</p>
                        </div>
                    </div>
            </div>
        ...
        <div class="follow-container-inner">
            <div class="inner-child">
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hc(3).png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hc(4).png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hc(5).png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hc(6).png" alt="pic" />
                </div>
            </div>
            <div class="inner-child">
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hc(7).png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hc(8).png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hc(9).png" alt="pic" />
                </div>
                <div class="follow-container-child">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hc(10).png" alt="pic" />
                </div>
            </div>
        </div>
    </div>
